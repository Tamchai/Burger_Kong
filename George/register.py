...
@app.post('/register')
def register(title :str, firstname :str, lastname :str, mobile :str, birthdate :str, confirm:bool):
    return Div(H3(f'{title} {firstname} {lastname} {mobile} {birthdate} {confirm}'))
